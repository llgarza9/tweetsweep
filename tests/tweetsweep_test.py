...
hashtag = "#RodneyReed" + " -filter:retweets" #Collects tweets that all have the specified hashtag excluding retweets
start_date = '2019-11-01' #From what date onward do you want to collect tweets?
tweet_num=10 #How many tweets do you want to collect?
...
with open('twitterdata_example.json','w', encoding='utf-8') as outfile_tweets:
    json.dump(tweets_list,outfile_tweets)
outfile_tweets.close()

#Save quick summary as txt file
outfile_counts = open('twitterdata_summary_example.txt','w', encoding = 'utf-8')
